...
<div class="max-w-lg mx-auto">
    <h1 class="text-2xl font-bold text-gray-900 mb-6">Catat Pemasukan</h1>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="{{ route('transactions.storeIncome') }}">
            ...
            <div class="flex gap-3 mt-6">
                ...
                <button type="submit" class="flex-1 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 font-medium">Simpan Pemasukan</button>
            </div>
        </form>
    </div>
</div>
